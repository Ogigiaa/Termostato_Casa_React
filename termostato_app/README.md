# Progetto per un termostato domotica sviluppato in React.js (Frontend) e Python v3.10
...
Per il backend è stato creato un virtualenv da PyCharm adatto 

Buona visione ed utilizzo  
